    ...
    <>
      <div className=" w-[20%] h-full border-r-2 border-zinc-200 p-3">
        ...
        <nav className=" flex flex-col text-zinc-400 text-xl gap-3">
          ...
          <Link to="/popular" className=" hover:bg-[#6556CD] hover:text-white duration-500 rounded-lg p-5 ">
          <i className="ri-bard-fill mr-2"></i>Popular
          </Link>
          <Link to="/movie" className=" hover:bg-[#6556CD] hover:text-white duration-500 rounded-lg p-5 ">
          <i className="ri-movie-2-fill mr-2"></i>Movies
          </Link>
          <Link to="tvshows" className=" hover:bg-[#6556CD] hover:text-white duration-500 rounded-lg p-5 ">
          <i className="ri-tv-2-fill mr-2"></i>Tv Shows
          </Link>
          <Link to="/people" className=" hover:bg-[#6556CD] hover:text-white duration-500 rounded-lg p-5 ">
