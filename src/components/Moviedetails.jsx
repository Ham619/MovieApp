...
import { ayncloadmovie, removemovie } from "../store/actions/movieAction.jsx";
        ...
        <div className=" content ml-[5%] text-white ">
          <h1 className=" text-5xl font-black text-white">
            {info.detail.name ||
              ...
              <span className=" text-2xl ml-1 font-bold text-zinc-300">({info.detail.release_date.split("-")[0]})</span>
          </h1>

          <div className=" mt-3 mb-5 flex text-white items-center gap-x-3 ">
            <span className={` ${getColorClass((info.detail.vote_average*10).toFixed())} text-xl font-semibold rounded-full text-white w-[5vh] h-[5vh] flex justify-center items-center`}>{(info.detail.vote_average*10).toFixed()}<sup>%</sup></span>
          ...
          <Link className=" mt-5 px-10 py-5 bg-[#6556CD] rounded-lg" to={`${pathname}/trailer`}><i class="  ri-play-fill mr-3"></i>Play Trailer</Link>
        </div>
      </div>
